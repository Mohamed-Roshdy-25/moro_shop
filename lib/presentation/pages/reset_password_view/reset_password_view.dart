...
class ResetPasswordView extends StatefulWidget {
  final String email;
  final String code;
  const ResetPasswordView({Key? key, required this.email, required this.code}) : super(key: key);
                ...
                child: Column(
                  children: [
                    const AuthHeaderWidget(
                        250, true, Icons.lock_reset_outlined),
                    SafeArea(
                      child: Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        if (_formKey.currentState!
                                            .validate()) {
                                          BlocProvider.of<ResetPasswordBloc>(context).add(PostResetPasswordEvent(widget.email, widget.code, _newPassController.text));
                                        }
                                      },
                                    ),
                                  ),
