...
class _VerifyCodeViewState extends State<VerifyCodeView> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<VerifyCodeBloc>(
        ...
        listener: (context, state) {
          ...
          if (state is VerifyCodeErrorState) {
            ErrorState(StateRendererType.popupErrorState, state.message)
              ...
              Navigator.pushNamed(context, Routes.resetPasswordRoute,arguments: {'email':widget.email,'pin':_pin});
            });
          }
        },
                ...
                child: Column(
                  children: [
                    const AuthHeaderWidget(
                        250, true, Icons.privacy_tip_outlined),
                    SafeArea(
                      child: Container(
