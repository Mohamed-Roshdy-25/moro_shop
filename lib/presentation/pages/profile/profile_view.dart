                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: data?.image != null && data!.image.isNotEmpty ? Image.network(data.image,fit: BoxFit.cover,height: 80,width: 80,) :Icon(
                            Icons.person,
                            size: 80,
                        ...
                        Text(
                          data?.name??'',
                          style: StyleManager.bodyStyle.copyWith(color: ColorManager.primary),
                        ),
                        const SizedBox(
                          height: 20,
                        ),
